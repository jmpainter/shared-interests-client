...
describe('<MessageThread />', () => {
  ...
  it('Renders a list of interests', () => {
    ...
    expect(wrapper.html()).toEqual('<div class=\"message-thread\"><div><div class=\"message-text\">Hello there</div><span class=\"message-sender\">josh - </span><span class=\"message-date\">9/12/2018</span></div><div><div class=\"message-text\"><p>This is a reply from amy</p></div><span class=\"message-sender\">amy - </span><span class=\"message-date\">9/27/2018</span></div><div><div class=\"message-text\"><p>Another message from Josh</p></div><span class=\"message-sender\">josh - </span><span class=\"message-date\">9/27/2018</span></div></div>');
  });
